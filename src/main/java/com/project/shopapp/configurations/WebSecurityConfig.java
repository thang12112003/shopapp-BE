...
public class WebSecurityConfig {// thiết lập các quy tắc bảo mật cho các yêu cầu HTTP đến các điểm cuối (endpoints) khác nhau của API dựa trên vai trò của người dùng (Role).
